...
def query(wrapped_prompt, MODEL_NAME) -> Response:
    ...
    try:
        ...
        for item in wrapped_prompt:
            ...
            with open("./test_Ministral-8B-Instruct.jsonl", "a") as file:
                file.write(json.dumps(response) + "\n")

        with open("responses_Ministral-8B-Instruct.json", "w", encoding="utf-8") as f:
...
if __name__ == '__main__':
    ...
    query(wrapped_prompt=prompts, MODEL_NAME="mistralai/Ministral-8B-Instruct-2410")
